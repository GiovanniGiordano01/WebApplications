...
function AsideButton(props){
    ...
    {props.Active!=props.Name && <a href="#" className='list-group-item list-group-item-action' onClick={() => {navigate("/FilmLibrary/" + props.Name); props.choose(props.Name)}}>{props.Name}</a>}
    </>);
}
